...
<a href="https://phet.colorado.edu/sims/html/ph-scale-basics/latest/ph-scale-basics_en.html" target="_blank">Click here
to run "pH Scale: Basics".</a>
...
(5) Open in the browser: `http://localhost/ph-scale-basics/ph-scale-basics_en.html` (You will probably need to modify
...
(3) Open in the
browser: `http://localhost/ph-scale-basics/build/adapted-from-phet/ph-scale-basics_en_adapted-from-phet.html` (You will
